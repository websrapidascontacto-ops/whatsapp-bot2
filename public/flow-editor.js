document.addEventListener("DOMContentLoaded", () => {
    ...
    function addTriggerNode() {
        const id = createNode("trigger", 0, 1, `
            <div class="node-wrapper">
                <div class="node-header header-trigger">⚡ Trigger</div>
                <div class="node-body">
                    <input type="text" class="form-control"
                    placeholder="Ej: hola"
                    oninput="updateNodeData(${editor.nodeId}, 'val', this.value)">
                </div>
            </div>
        `);
    }
        ...
        createNode("ia", 1, 1, `
            <div class="node-wrapper">
                ...
                <div class="node-body">
                    ...
                    oninput="updateNodeData(${editor.nodeId}, 'info', this.value)">
Base: S/380. WhatsApp: 991138132.
        ...
        createNode("message", 1, 1, `
            <div class="node-wrapper">
                ...
                <div class="node-body">
                    ...
                    oninput="updateNodeData(${editor.nodeId}, 'info', this.value)"></textarea>
                </div>
            </div>
        `);
    }
        ...
        const id = createNode("menu", 1, 1, `
            <div class="node-wrapper">
                ...
                <div class="node-body">
                    ...
                    <div class="menu-list" id="list-${editor.nodeId}">
                        <input type="text" class="form-control mb-1"
                        placeholder="Opción 1"
                        oninput="updateNodeData(${editor.nodeId}, 'option1', this.value)">
                    </div>

                    <button class="btn btn-outline-primary btn-sm w-100 mt-2"
                    onclick="addOption(${editor.nodeId})">+ Opción</button>
                </div>
            </div>
        `);
    ...
    window.saveFlow = async function() {
        ...
        Object.keys(nodes).forEach(id => {
            ...
            if (node) editor.updateNodeDataFromId(id, node.data);
        });
